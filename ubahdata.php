...
<!-- Header -->
    ...
    <nav class="navbar navbar-expand-lg  " style="background-color: rgb(255, 224, 167);">
        ...
        <form action="<?php echo $ubahdataok?>" method="POST" style="margin-left: 10px;margin-top:10px;">
            ...
            <label for="tanggal_perjalanan">Tanggal perjalanan sebelumnya <?php echo $mydata['tanggal_perjalanan'];?></label> <br>
            <input type="text" placeholder="tanggal perjalanan baru" id="tanggal_perjalanan" name="tanggal_perjalanan"> <br> <br>

            <label for="jumlah_orang">Jumlah orang sebelumnya : <?php echo $mydata['jumlah_orang'];?></label> <br>
            <input type="number" placeholder="jumlah orang diubah ke" id="jumlah_orang" name="jumlah_orang"> <br> <br>

            <button type="submit" class="btn btn-danger">Ubah data</button>
            <!-- <a href="<?php echo $deletedataok?>" class="btn btn-danger">Hapus</a> -->

...
<h4>Nama : <?php echo $mydata['nama']; ?></h4>
<h4>Nomor Hp : <?php echo $mydata['nomor_hp']; ?></h4>
<h4>Tanggal wisata : <?php echo $mydata['tanggal_perjalanan']; ?></h4>
<h4>Jumlah orang : <?php echo $mydata['jumlah_orang']; ?></h4>
